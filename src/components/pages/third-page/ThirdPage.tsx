...
const ThirdPage: React.FC<ThirdPageProps> = ({ onNext, onPrev }) => {
  return (
    ...
    >
      <Section>
        ...
        >
          <p>
            ...
            into simple, logical steps. That's where algorithms and data
            structures come in — they're not just academic concepts, they're
            tools for thinking.
          </p>
        </motion.div>
      </Section>
      ...
      <Section>
        <SectionTitle>Data Structures: Organising Chaos</SectionTitle>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <p>
            Stacks, queues, trees — each structure is optimised for specific
            problems. Try the stack below:
          </p>
          <DataStructureDemo />
        </motion.div>
      </Section>
      ...
      <Section>
        ...
        >
          <p>The best way to learn? Solve problems. Here's a quick challenge:</p>
          <CodingChallenge />
        </motion.div>
      </Section>
