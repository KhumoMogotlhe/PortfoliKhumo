...
import type { Props } from './LanguageJourney.types';
import {
  Icon,
  IconContainer,
  JavaScriptScene,
  ...
  const steps = [
    {
      ...
      title: 'Then came Python',
      description:
        'My first real language. Lists, loops, functions — building blocks that taught me to think algorithmically.',
      SceneComponent: PythonScene,
    },
    {
      id: 'javascript',
      ...
      title: 'JavaScript brought interaction',
      description:
        'Suddenly, things could respond. Click, hover, change. The web became alive.',
      SceneComponent: JavaScriptScene,
    },
    {
      id: 'web',
      ...
      title: 'HTML & CSS gave it form',
      description:
        'Structure met style. Semantic markup, responsive layouts — the art of making information beautiful.',
      SceneComponent: WebScene,
    },
  ];
